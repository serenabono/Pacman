...
#500-learnability2agents_BoltzmannAgent_Egreedy_v3_DirectionalGhost_{"index":1,"prob":0.3}_{"mean":0,"std":0}_v3_DirectionalGhost_{"index":1,"prob":0.3}_{"mean":0,"std":0}/: 335
