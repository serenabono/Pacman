...
class BoltzmannAgent(Agent):
    ...
    def getAction(self, state, transitionFunctionTree, game_number, total_games, isInitial):
        ...
        state_rep = str(state)
        actions_rep = transitionFunctionTree.transitionMatrixDic[transitionFunctionTree.getHashfromState(state)].keys()
